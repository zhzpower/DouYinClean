...
- (void)clicked:(AWEShareIconAndTitleCell *)arg {
    ...
    if (type == 107) {
        ...
        [alert addAction:[UIAlertAction actionWithTitle:@"无水印" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            UITabBarController *tabVC = (UITabBarController *)[%c(ALBBUtils) getTopViewController];
            ...
            AWEFeedCellViewController *viewController = (AWEFeedCellViewController *)[curCell viewController];
            [self dismiss];
